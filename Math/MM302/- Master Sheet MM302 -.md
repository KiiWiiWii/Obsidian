...
In the [[Ratio Test]], $R$ is introduced as the radius of convergence. [[Radius of Convergence#Theorem 1]] describes for what values of $x$ this radius is defined or not. After the [[Ratio Test]] is introduced, it is immediately made obsolete by the better ratio test - [[Theorem 2]].
