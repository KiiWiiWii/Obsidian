A single point $x = x_{0}$ is called a regular single point if $(x-x_{0})p(x)$ and $(x-x_{0})^{2}q(x)$ are [[Analytic Functions]] at $x = x_{0}$. Else it is called an irregular single point.
